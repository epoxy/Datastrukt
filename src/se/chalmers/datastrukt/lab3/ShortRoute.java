	...
	*/
	...
	private void readAndDrawGraph() {
		...
		try {
			...
			indata = new Scanner(new File("./src/se/chalmers/datastrukt/lab3/stops.noBOM.txt"), "UTF-8");
			...
			indata =  new Scanner(new File("./src/se/chalmers/datastrukt/lab3/lines.noBOM.txt"), "UTF-8");
